...
## Deploy 
 ...
 3. Go to this forked repo and set secrets with name `Lieki` and fill with KV settings ID
 4. Edit this `README.md` file, then find and replace this button url bellow with yours `https://github.com/lukiekov/v2ray-worker` then save it.
